    ...
    <div className="container">
      <div className="row">
        <div className="col-md-8 ftco-animate">
          ...
          <p>
            <img src="src/images/image_7.jpg"  className="img-fluid" />
          </p>
          ...
          <p>
            <img src="src/images/image_8.jpg" className="img-fluid" />
          </p>
          ...
          <div className="about-author d-flex p-4 bg-light">
            <div className="bio mr-5">
              <img src="src/images/person_1.jpg" alt="Image placeholder" className="img-fluid mb-4" />
            </div>
            <div className="desc">
        ...
        <div className="col-md-4 sidebar ftco-animate">
          ...
          <div className="sidebar-box ftco-animate">
            ...
            <div className="block-21 mb-4 d-flex">
              <a className="blog-img mr-4" style={{backgroundImage: 'url(src/images/image_1.jpg)'}} />
              <div className="text">
            ...
            <div className="block-21 mb-4 d-flex">
              <a className="blog-img mr-4" style={{backgroundImage: 'url(src/images/image_2.jpg)'}} />
              <div className="text">
                <h3 className="heading"><a href="#">Why Lead Generation is Key for Business Growth</a></h3>
                <div className="meta">
                  <div><a href="#"><span className="icon-calendar" />Oct. 29, 2019</a></div>
            ...
            <div className="block-21 mb-4 d-flex">
              <a className="blog-img mr-4" style={{backgroundImage: 'url(src/images/image_3.jpg)'}} />
              <div className="text">
                <h3 className="heading"><a href="#">Why Lead Generation is Key for Business Growth</a></h3>
                <div className="meta">
                  <div><a href="#"><span className="icon-calendar" />Oct. 29, 2019</a></div>
