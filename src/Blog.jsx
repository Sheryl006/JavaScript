      ...
      <div className="row d-flex justify-content-center">
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry justify-content-end mb-md-5">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_1.jpg")'}}>
            </a>
        ...
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry justify-content-end mb-md-5">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_2.jpg")'}}>
            </a>
            <div className="text px-md-5 pt-4">
              <div className="meta mb-3">
                <div><a href="#">Oct. 29, 2019</a></div>
        ...
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_3.jpg")'}}>
            </a>
            <div className="text px-md-5 pt-4">
              <div className="meta mb-3">
                <div><a href="#">Oct. 29, 2019</a></div>
        ...
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry justify-content-end mb-md-5">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_4.jpg")'}}>
            </a>
            <div className="text px-md-5 pt-4">
              <div className="meta mb-3">
                <div><a href="#">Oct. 29, 2019</a></div>
        ...
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry justify-content-end mb-md-5">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_5.jpg")'}}>
            </a>
            <div className="text px-md-5 pt-4">
              <div className="meta mb-3">
                <div><a href="#">Oct. 29, 2019</a></div>
        ...
        <div className="col-md-12 text-center d-flex ftco-animate">
          <div className="blog-entry">
            <a href="blog-single.html" className="block-20 img" style={{backgroundImage: 'url("src/images/image_6.jpg")'}}>
            </a>
            <div className="text px-md-5 pt-4">
              <div className="meta mb-3">
                <div><a href="#">Oct. 29, 2019</a></div>
